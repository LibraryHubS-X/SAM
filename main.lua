...
adoptBtn.MouseButton1Click:Connect(function()
	...
	closeUI()
	task.spawn(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/LibraryHubS-X/SAM/refs/heads/main/adoptme.lua"))()
	end)
end)
...
mm2Btn.MouseButton1Click:Connect(function()
	...
	closeUI()
	task.spawn(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/LibraryHubS-X/SAM/refs/heads/main/mm2.lua"))()
	end)
end)
